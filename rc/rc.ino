...
void setup() {
  ...
  if (esp_sleep_get_wakeup_cause() != ESP_SLEEP_WAKEUP_TIMER) {
    ...
    // Clear "data.txt" on boot but not after waking up from deep sleep
    LittleFS.remove("/data.txt"); // Comment/Uncomment this line to disable/enable clearing data on reboot
  }
